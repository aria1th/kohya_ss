...
class BaseSubsetParams:
    ...
    cleanup_noise: Optional[bool] = None
    ...
    """
      ...
      \n"""
        ...
        [Subset {j} of Dataset {i}]
          ...
          cleanup_noise: {subset.cleanup_noise},
      """
                ),
                "  ",
            )
...
def generate_dreambooth_subsets_config_by_subdirs(
    ...
    def generate(
        ...
        for subdir in base_dir.iterdir():
            ...
            if cleanup_noise is not None:
                subset_config["cleanup_noise"] = cleanup_noise
            subsets_config.append(subset_config)

        return subsets_config

    subsets_config = []
    subsets_config += generate(
        train_data_dir, False, mask_dir=mask_dir, shift_images_dir=shift_images_dir, cleanup_noise=cleanup_noise
    )
    subsets_config += generate(
        reg_data_dir, True, mask_dir=mask_dir, shift_images_dir=shift_images_dir, cleanup_noise=cleanup_noise
    )
